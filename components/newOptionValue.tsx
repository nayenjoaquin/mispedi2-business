    ...
    return(
        <motion.div variants={variants} initial='hidden' animate='visible'  className="relative w-full flex justify-between items-center">
            ...
            <div className="border-b-2 border-gray-200 flex items-center relative  rounded px-5">
                <input onChange={e=>{handleValueChange(e,option.id,value.id)}} className=" outline-none w-24 bg-transparent " placeholder="nuevo valor"/>
            </div>
            <div className="flex flex-col-reverse items-center">
                <input
                    ...
                    onChange={e=>{
                        handleValuePriceSwitch(e,option.id,value.id)
                    }}
            ...
            </div>
            {
                ...
                <input
                    ...
                    onChange={e=>{handleValuePriceChange(e,option.id,value.id)}}
                />
            }
