...
export default function BorderBottomNavItem(props: props) {
    ...
    return(
        <div className='relative'>
            <li onClick={e=>{onClick(label)}} className={`text-md xl:text-xl py-2.5 font-medium cursor-pointer transition-all hover:border-b-2 hover:border-main-500  hover:bg-neutral-100 ${active && "bg-neutral-100"} `}>{label}</li>
