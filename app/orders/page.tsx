            ...
            <header className="w-full max-w-2xl xl:max-w-4xl flex justify-center  bg-white h-nav rounded-xl">
                <nav>
                    <ul className="h-full flex items-center gap-5">
                        <AnimatePresence>
                        <BorderBottomNavItem label="Nuevo" onClick={handleTabClick} active={activeTab === 'Nuevo'} />
                        <BorderBottomNavItem label="Confirmado" onClick={handleTabClick} active={activeTab === 'Confirmado'} />
                        <BorderBottomNavItem label="Rechazado" onClick={handleTabClick} active={activeTab === 'Rechazado'} />
                        <BorderBottomNavItem label="Entregado" onClick={handleTabClick} active={activeTab === 'Entregado'} />
                        </AnimatePresence>
                    </ul>
                </nav>
